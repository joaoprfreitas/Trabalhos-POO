...
class Login:
    ...
    def __init__(self):
        ...
        self.__layout = [[sg.Button(image_data=imagem, button_color=(cor, cor), border_width=0, image_subsample=20), sg.Push(), sg.Push(), sg.Text(text='   Tela de Login', font=self.fonte), sg.Push(), sg.Push(), sg.Push()],
                         ...
                         [sg.Button('Logar', key='-LOGIN-', font=self.fonte)]]
    ...
    def manipulation(self, window, keyLastLayout):
...
if __name__ == '__main__':
    ...
    window = sg.Window(title=log.getTitle(), layout=log.getLayout())
    log.manipulation(window, [])